...
def select_decision_prompt_path(planning_mode: str, exploration_mode: Optional[str] = None) -> str:
    ...
    if planning_mode == "conservative":
        return r"/home/himankjain/S9/prompts/decision_prompt_conservative.txt"
    elif planning_mode == "exploratory":
        if exploration_mode == "parallel":
            return r"/home/himankjain/S9/prompts/decision_prompt_exploratory_parallel.txt"
        elif exploration_mode == "sequential":
            return r"/home/himankjain/S9/prompts/decision_prompt_exploratory_sequential.txt"
    return r"/home/himankjain/S9/prompts/decision_prompt_conservative.txt"  # safe fallback
